...
def open_location(p):
    try:
        ...
        update_info_label(app, f"File not found: {p}", "red")
    except Exception as e:
        update_info_label(app, f"Error opening location: {str(e)}", "red")
...
def run_file(p):
    try:
        ...
        update_info_label(app, f"Error opening file: {str(e)}", "red")
