...
class FileComparator:
    ...
    def show_comparison(self):
        ...
        # Create frames for the file previews and actions
        previews_frame = tk.Frame(self.canvas_frame, height=int(0.2 * self.root.winfo_height()))
        ...
        # Display the paths of the files being compared
        ...
        for i, (size, path) in enumerate(files):
            ...
            create_delete_button(frame, path, name)
